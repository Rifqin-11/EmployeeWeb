                  ...
                  <form action="<?= base_url('settings/employees/edit') ?>" method="post" class="p-4 md:p-5">
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2">
                      ...
                      <div class="col-span-2">
                        ...
                        <div class="flex items-center mb-2">
                            <input id="default-checkbox" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-blue-300 border-gray-300 rounded-sm focus:ring-blue-500 focus:ring-2">
                            <label for="default-checkbox" class="ms-2 text-sm font-medium text-gray-900">Change Password?</label>
                        </div>
                        <input type="password" name="new_password" id="new_password" class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" placeholder="Enter new password" required>
                      </div>
                    </div>
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
          ...
          checkbox.addEventListener('change', function() {
            ...
            newPasswordInput.classList.toggle('bg-gray-200');
          });
        });
      // Close Modal
