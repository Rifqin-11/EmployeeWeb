...
<html>
  ...
  <body>
    ...
    <?php if (session()->getFlashdata('error')) : ?>
      <div id="toast-danger" class="fixed bottom-4 right-4 z-50 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-md border border-gray-200" role="alert">
